...
C {devices/opin.sym} 1180 -60 0 0 {name=p30 lab=brout_filt}
...
C {inv_4.sym} -860 420 0 0 {name=xIinv0 VGND=dvss VNB=dvss VPB=dvdd VPWR=dvdd prefix=sky130_fd_sc_hd__ }
C {inv_16.sym} -740 420 0 0 {name=xIinv1 VGND=dvss VNB=dvss VPB=dvdd VPWR=dvdd prefix=sky130_fd_sc_hd__ }
