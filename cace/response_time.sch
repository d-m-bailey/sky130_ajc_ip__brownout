...
Description: Brown-out detector response-time CACE testbench} -1200 -70 0 0 0.4 0.4 {}
N -210 -610 -200 -610 {
lab=avdd_bg}
N -200 -660 -200 -610 {
lab=avdd_bg}
...
C {xschem/sky130_ajc_ip__brownout.sym} 150 -170 0 0 {name=xIbrout}
...
C {devices/vsource.sym} 620 -680 0 0 {name=Vavdd value="pwl (0 3.0 10u 3.0 10.01u 2.4 100u 2.4 100.01u 3.0) DC \{Vavdd\}" savecurrent=true}
...
meas tran tript_f_br when v(out)=$&dvdd2 fall=1
meas tran tript_f_vu when v(vunder)=$&dvdd2 fall=1
...
.endc
"}
C {devices/vsource.sym} 0 -680 0 0 {name=Vforce_rc_osc value="DC 0" savecurrent=false}
