...
Description: Brown-out detector response-time CACE testbench} -1190 130 0 0 0.4 0.4 {}
N -210 -610 -200 -610 {
lab=avdd_bg}
N -200 -660 -200 -610 {
lab=avdd_bg}
...
C {devices/vsource.sym} 0 -440 0 0 {name=Vena value="pwl(0 0 1u [\{ena\}*\{Vdvdd\}])" savecurrent=false}
C {devices/gnd.sym} 0 -390 0 0 {name=l15 lab=GND}
C {devices/lab_pin.sym} 0 -470 2 0 {name=p38 sig_type=std_logic lab=ena}
C {devices/vsource.sym} 640 -680 0 0 {name=Vavdd value="pwl (0 3 800u 3 800.1u 2.4 1000u 2.4 1000.1u 3) DC \{Vavdd\}" savecurrent=true}
...
C {devices/vsource.sym} 420 -440 0 0 {name=Vvvtrip0 value="DC [\{vtrip[0]\}*\{Vdvdd\}]" savecurrent=true}
C {devices/lab_pin.sym} 420 -470 2 0 {name=p1 sig_type=std_logic lab=vtrip[0]}
C {devices/vsource.sym} 420 -520 0 0 {name=Vvvtrip1 value="DC [\{vtrip[1]\}*\{Vdvdd\}]" savecurrent=true}
C {devices/lab_pin.sym} 420 -550 2 0 {name=p2 sig_type=std_logic lab=vtrip[1]}
C {devices/vsource.sym} 420 -600 0 0 {name=Vvvtrip2 value="DC [\{vtrip[2]\}*\{Vdvdd\}]" savecurrent=true}
C {devices/lab_pin.sym} 420 -630 2 0 {name=p4 sig_type=std_logic lab=vtrip[2]}
C {devices/vsource.sym} 420 -680 0 0 {name=Vvvtrip3 value="DC [\{vtrip[3]\}*\{Vdvdd\}]" savecurrent=true}
C {devices/lab_pin.sym} 420 -710 2 0 {name=p5 sig_type=std_logic lab=vtrip[3]}
...
.save all
"}
C {devices/code_shown.sym} -1200 -350 0 0 {name=CONTROL only_toplevel=false value=".csparam dvdd2=[\{Vdvdd\}/2]
.control
tran 1u 2m
