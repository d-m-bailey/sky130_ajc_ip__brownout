...
C {devices/vsource.sym} 210 -680 0 0 {name=Vvotrip3 value="DC CACE[CACE\{otrip[3]\}*CACE\{Vdvdd\}]" savecurrent=true}
...
C {devices/vsource.sym} 420 -680 0 0 {name=Vvvtrip3 value="DC CACE[CACE\{vtrip[3]\}*CACE\{Vdvdd\}]" savecurrent=true}
...
.save all
"}
C {devices/code_shown.sym} -1200 -350 0 0 {name=CONTROL only_toplevel=false value=".csparam dvdd2=CACE[CACE\{Vdvdd\}/2]
.control
tran 1u 2m
...
echo $&prop_f_br > CACE\{simpath\}/CACE\{filename\}_CACE\{N\}.data
echo $&prop_f_vu >> CACE\{simpath\}/CACE\{filename\}_CACE\{N\}.data
echo $&osc_ck_period >> CACE\{simpath\}/CACE\{filename\}_CACE\{N\}.data
echo $&osc_ck_freq >> CACE\{simpath\}/CACE\{filename\}_CACE\{N\}.data
quit
.endc
"}
